<x-app-layout>
    ...
    <div class="bg-white rounded-[3rem] shadow-sm border border-slate-100 ring-1 ring-slate-900/5 overflow-hidden mt-4">
        <div class="px-10 py-8 border-b border-slate-50 bg-slate-50/30 flex justify-between items-center">
            <h3 class="font-black text-slate-800 uppercase tracking-tight italic">Daftar Harga Layanan</h3>
    ...
    <tr class="hover:bg-slate-50/50 transition-all group">
        ...
        <td class="px-10 py-6">
            <span class="text-sm font-medium text-slate-600 tracking-tight">
                {{ $service->name }}
            </span>
        </td>
    ...
    @empty
    <tr>
        <td colspan="4" class="px-10 py-20 text-center text-slate-400">Belum ada data layanan.</td>
    </tr>
    @endforelse
</tbody>
            </table>
